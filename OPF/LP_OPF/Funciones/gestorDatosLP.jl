function gestorDatosLP(Generador::DataFrame, Nodo::DataFrame, nn::Int, bMVA::Int)
    ...
    # El Dataframe introducido como argumento "dNodo" en "Nodo" contiene los datos de la demanda sacado de su correspondiente archivo "datosNodos.csv"
    ...
    return P_Cost0, P_Cost1, P_Cost2, P_Gen_lb, P_Gen_ub, Gen_Status, P_Demand, Conduc_Sh
